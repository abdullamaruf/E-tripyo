      ...
      <div className='py-10'>
        ...
        <div className='flex flex-col xl:flex-row gap-20 mt-20'>
          ...
          <div className='flex flex-1 flex-col gap-8'>
            ...
            <div className='flexBetween h-[2.8rem] bg-primary ring-1 ring-slate-900/10 w-full max-w-[488px] rounded mb-24 items-center'>
              <input
                type='text'
              ...
              <div>
                <button
                  type='submit'
                  className='bg-black text-white text-xs px-10 bold-15 py-4'
                >
                  Submit
                </button>
              </div>
