  ...
  return (
    ...
    <section className='max-padd-container flex flex-col gap-8 xl:flex-row bg-primary py-4'>
      ...
      <div className='flex-col flex xl:flex-[1.5] bg-white px-6 py-2 rounded-xl'>
        ...
        {/* proucts color button  */}

        <div className='flex flex-col sm:flex-row gap-x-10 gap-y-3 my-4'>
          <div>
            <h4 className='bold-16'>Select Color</h4>
            <div className='flex gap-3 my-3'>
              <div className='bg-secondaryRed  h-10 w-10 border-b-black active-color cursor-pointer rounded-sm flexCenter'></div>

              <div className='bg-secondaryYellow  h-10 w-10 border-b-black active-color cursor-pointer rounded-sm flexCenter'></div>

              <div className='bg-secondaryBlue  h-10 w-10 border-b-black active-color cursor-pointer rounded-sm flexCenter'></div>

              <div className='bg-secondaryGreen  h-10 w-10 flexCenter border-b-black active-color cursor-pointer rounded-sm '></div>
            </div>
          </div>
          <div>
